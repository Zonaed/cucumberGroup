...
public class AmazonDefn {
	...
	@When("^we input username as \"(.*)\" password as \"(.*)\" and click on login button$")
	public void login_to_Amazon(String user, String pass) throws IOException {
	    File file=new File("C:\\Users\\MD ZONAED BHUIYAN\\eclipse-workspace\\CucumberGroup\\src\\test\\java\\util\\pasword.xlsx");
		...
		driver.findElement(By.xpath (get_value("username"))).sendKeys(user2);
		driver.findElement(By.xpath(get_value("password"))).sendKeys(pass2);
		driver.findElement(By.xpath(get_value("login_click"))).click();
	...
	public static String get_value(String arg) throws IOException {
		String value="";
		File file=new File("C:\\Users\\MD ZONAED BHUIYAN\\eclipse-workspace\\CucumberGroup\\src\\test\\java\\property\\Amazon.properties");
